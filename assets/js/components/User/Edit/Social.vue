...
export default {
  ...
  data() {
    return {
      form: {
        steam: this.social.steam,
        origin: this.social.origin,
        ubisoft: this.social.ubisoft,
        battlenet: this.social.battlenet,
        facebook: this.social.facebook,
        gog: this.social.gog,
        instagram: this.social.instagram,
        lol: this.social.lol,
        nintendo: this.social.nintendo,
        psn: this.social.psn,
        rockstar: this.social.rockstar,
        skype: this.social.skype,
        snapchat: this.social.snapchat,
        twitch: this.social.twitch,
        twitter: this.social.twitter,
        wargaming: this.social.wargaming,
        xbox: this.social.xbox,
